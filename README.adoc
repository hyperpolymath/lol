...
:experimental:
:url-github: https://github.com/hyperpolymath/LOL
:url-gitlab: https://gitlab.com/hyperpolymath/LOL
:url-bitbucket: https://bitbucket.org/hyperpolymath/LOL
:url-codeberg: https://codeberg.org/hyperpolymath/LOL

Lots of Logging - structured logging library
...
LOL is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
