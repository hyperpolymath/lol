...
* Respecting the time and attention of maintainers and other contributors
...
* Demanding immediate responses or attention from maintainers
* Dismissing or attacking constructive criticism
